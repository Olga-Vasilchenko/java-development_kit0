...
/*
Первое задание – добавить на экран компоновщик-сетку с одним столбцом
...
и «Человек против человека», JLabel с заголовком «Выберите размеры поля»,
JLabel с заголовком «Установленный размер поля:», JSlider со значениями 3..10,
...
public class SettingsWindow extends JFrame {
    ...
    JRadioButton numanVsAi = new JRadioButton("Человек против компьютера");
    JRadioButton numanVsHuman = new JRadioButton("Человек против человека");
    ...
    SettingsWindow(GameWindow gameWindow){
        ...
        gameModeButtonsGroup.add(numanVsAi);
        gameModeButtonsGroup.add(numanVsHuman);
        panBottom.add(gameMode);
        panBottom.add(numanVsAi);
        panBottom.add(numanVsHuman);
        panBottom.add(gameField);
        panBottom.add(fieldSlider);
        panBottom.add(winCount);
        panBottom.add(winLengthSlider);
        panBottom.add(btnStart);
        numanVsAi.setSelected(true);
        ...
        btnStart.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                gameWindow.startNewGame(numanVsAi.isSelected()?0:1,
